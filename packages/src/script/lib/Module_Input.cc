...
void Module_Input::open(core::AutoPtr<Script> ctx) {
  ...
  auto scancodes =
      ctx->createValue()
          ...
          ->setField(ctx, "1", createNumber(ctx, SDL_SCANCODE_1))
          ->setField(ctx, "2", createNumber(ctx, SDL_SCANCODE_2))
          ->setField(ctx, "3", createNumber(ctx, SDL_SCANCODE_3))
          ->setField(ctx, "4", createNumber(ctx, SDL_SCANCODE_4))
          ->setField(ctx, "5", createNumber(ctx, SDL_SCANCODE_5))
          ->setField(ctx, "6", createNumber(ctx, SDL_SCANCODE_6))
          ->setField(ctx, "7", createNumber(ctx, SDL_SCANCODE_7))
          ->setField(ctx, "8", createNumber(ctx, SDL_SCANCODE_8))
          ->setField(ctx, "9", createNumber(ctx, SDL_SCANCODE_9))
          ->setField(ctx, "0", createNumber(ctx, SDL_SCANCODE_0))
