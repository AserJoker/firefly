...
private:
  ...
  void TEST_indexOf(void) {
    ...
    CU_ASSERT_EQUAL(array.indexOf(1), 1);
    CU_ASSERT_EQUAL(array.indexOf(-1), array.size());
  }

  void TEST_equal(void) {
    core::Array<int32_t> array{{0, 1, 2, 3, 4}};
    core::Array<int32_t> array2{{0, 1, 2, 3, 4}};
    CU_ASSERT(array == array2);
  }

  void TEST_replace(void) {
    core::Array<int32_t> array{{0, 1, 1, 1, 4}};
    array.replace(1, 2);
    CU_ASSERT(array.contains(1));
    CU_ASSERT(array.contains(2));
